...
#wall{
	height:90vh;
	width:100%;
	background-image: url("./images/newAdmin.svg");
...
<body style="margin-top:1%;">
	...
	<div id="loginSuccessBox" class="popup">
		<div class="popup-content" style="width:25vw;height:30vh">
				<h3 style="color:#4f52ff;">Created login successfully!</h3><br>
...
<!--Header-->
	...
	<div class="dashboard" style="displaye: flex; flex-direction: row;background-color:white;">
		<div class="panel" style="display: flex; flex-direction: column; width: 20vw; padding: 2%; height: fit-content; background-color: #f4f4f5;border-top-left-radius: 0%;border-top-right-radius: 80%;border-bottom-left-radius: 0%;border-bottom-right-radius: 80%">
			...
			<div class="column" style="padding:3%">
				...
				<div class="col">
					<div class="collapse multi-collapse login-collapse show"
						id="login" onclick='redirectTo("add_new_login.jsp")' style="padding:2%;background-color:#4f52ff;
	color:white;
	cursor:pointer;">
						<h6
							>Add 
	...
	<div style="display:flex;flex-direction:column;width:85vw;" id ="wall">
		   ...
		   <form action="signup" method="post" enctype="multipart/form-data" style="margin:5%;box-shadow: 0 4px 8px #7f888e;padding:3%;width:30vw;background-color: rgba(255, 255, 255, 0.9);text-align:left" onsubmit="return handleSubmit()">
	       <h2> Add New Admin</h2><br><br>
            	
                <label style="font-weight:600;font-size:2vh;color:#4f52ff">User Name</label><br>
                <input type="text"  required  name="username" style="font-weight:600;"><br /><br>

				<label style="font-weight:600;font-size:2vh;color:#4f52ff">Email</label><br>
                <input type="email"  required  name="email" style="font-weight:600;"><br /><br>

                <label style="font-weight:600;font-size:2vh;color:#4f52ff">Password</label><br>
                <input type="password"  required id="pw" name="password" style="font-weight:600;"pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Password must contain at least one number, one uppercase and lowercase letter, and be at least 8 characters long"><br /><br>
				...
				<label style="font-weight:600;font-size:2vh;color:#4f52ff">Upload Profile Image</label><br>
            	<input type = "file" name="pic" required><br><br><br>


                <div style="display:flex;flex-direction:column;justify-content:center;align-items:center;">
                <button type="submit" id="altBtn" style="width:10vw">Add</button></div>
