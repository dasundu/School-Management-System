...
#wall{
	height:90vh;
	width:100%;
	background-image: url("./images/newStu.svg");
...
<body style="margin:1%;background-color:#273239;">
	...
	<div id="loginSuccessBox" class="popup">
		<div class="popup-content" style="width:25vw;height:30vh">
				<h3 style="color:#4f52ff;">Student added successfully!</h3><br>
			...
			<div class="column" style="padding:3%">
				<div class="col">
					<div class="collapse multi-collapse students-collapse show"
						id="addStudent" onclick='redirectTo("http://localhost:8090/TestingPROJECT/add_new_student_page_loader")' style="padding:2%;	background-color:#4f52ff;
	color:white;
	cursor:pointer;">
						<h6
							>Enroll a new
				...
				<div class="col">
					<div class="collapse multi-collapse students-collapse show"
						id="manageStudents" onclick='redirectTo("http://localhost:8090/TestingPROJECT/studentsPageLoader")' style="padding:2%">
						<h6
							>Manage
							Students</h6>
					</div>
	...
	<div style="display:flex;flex-direction:column;width:85vw;" id ="wall">
	       ...
	       <form action="add_new_student" method="post" enctype="multipart/form-data" style="margin:5%;box-shadow: 0 4px 8px rgba(79, 82, 255, 0.5);padding:3%;width:fit-content;display:flex;flex-direction:column;width:48vw;background-color: rgba(255, 255, 255, 0.9);" onsubmit="return handleSubmit()">
	       ...
	       <div style="display:flex;flex-direction:row;">
	       	...
	       	<legend>Account Info</legend>
                ...
                <input type="text"  required id="pw" name="username"><br /><br>

				<label>Email</label><br>
                <input type="email"  required id="pw" name="email"><br /><br>

                <label>Password</label><br>
                <input type="password"  required id="studentPass" name="password"pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Password must contain at least one number, one uppercase and lowercase letter, and be at least 8 characters long"><br /><br>

				<label style = "font-weight:600;font-size:2vh;">Upload Student Photo</label><br>
			...
			<fieldset>
	       	<legend>Student Info</legend>
                ...
                <input type="text"  required id="pw" name="firstname"><br /><br>

				<label>Last Name</label><br>
                <input type="text"  required id="pw" name="lastname"><br /><br>

				
				<label>Birth Date</label><br>
                <input type="date"  required id="pw" name="birthday"><br /><br>
                
                <label>Telephone</label><br>
                <input type="text"  required id="pw" name="telephone"pattern="[0-9]{10}" title="Please enter a 10-digit phone number"><br /><br>
                
                <label>Address</label><br>
                <input type="text"  required id="pw" name="address"><br /><br>
                
                <label for="classSelect">Select Class:</label><br>
    			<select name="classSelect">
        			<c:forEach var="classr" items="${Allclasses}">
			...
			<button type="submit" id="altBtn" style="width:12vw;">Enroll</button></div>
            </form>
	</div>
...
<script>
  ...
  function handleSubmit() {
    ...
    const passwordInput = document.getElementById('studentPass').value;
    ...
    document.getElementById('studentPass').value = hashedPassword;
