...
<body style="margin:1%;background-color:#273239;">
	...
	<div class="dashboard" style="displaye: flex; flex-direction: row;background-color:white;border-bottom-right-radius: 5%;">
		<div class="panel" style="display: flex; flex-direction: column; width: 20vw; padding: 2%; height: fit-content; background-color: #f4f4f5;border-top-left-radius: 0%;border-top-right-radius: 80%;border-bottom-left-radius: 0%;border-bottom-right-radius: 80%">
			...
			<div class="column" style="padding:3%"> 
				<div class="col">
					<div class="collapse multi-collapse set-collapse show"
			...
			<div class="column">
				<div class="col">
					<div class="collapse multi-collapse set-collapse show"
						id="set" onclick='redirectTo("teacher_delete_account.jsp")' style="padding:3%;background-color:#4f52ff;
	color:white;
	cursor:pointer;">
						<h6
							>Account Deletion
	...
	<div style="diplay:flex;flex-direction:column;justify-content:center;align-items:center;text-align:center;width:70vw;" id = "wall">
		<div style="margin:10%;box-shadow: 0 4px 8px #263339;padding:5%;background-color: rgba(255, 255, 255, 0.9);width:50vw">
			
				
				<p style="font-weight:600;font-size:2vh">Deleting your account will result in the <span style="color:red">permanent loss of your profile, data, and associated information</span>. Make sure to backup any important data or content you wish to retain before initiating the deletion.
					Please note that account deletion is <span style="color:red">irreversible </span>, and you won't be able to recover your account once it's deleted</p>
			
				<button id="yesBtn"  style="width:10vw" onclick=showPopupDelete()>Delete My Account</button>
			</div>
		</div>
	</div>
	<script>
