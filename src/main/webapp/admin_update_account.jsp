...
<body style="margin: 1%; background-color: #273239;">
	...
	<!--Dashboard-->
	<div class="dashboard"
		style="displaye: flex; flex-direction: row; background-color: white;">
		<div class="panel"
		...
		<div style="display: flex; flex-direction: row; width: 70vw;"
			...
			<form action="user_update_profile" method="post"
				...
				style="margin: 5%; box-shadow: 0 4px 8px rgba(79, 82, 255, 0.5); padding: 3%; width: fit-content; display: flex; flex-direction: column; justify-content: center; height: fit-content; background-color: rgba(255, 255, 255, 0.95);">
				...
				<br> <br> <label style="font-weight: 600; font-size: 2vh;">User
				...
				<label style="font-weight: 600; font-size: 2vh;">Change
					Profile Image</label> <input type="file" name="pic"><br> <br>
			...
			<form action="change_password" method="post"
				style="margin: 5%; box-shadow: 0 4px 8px rgba(79, 82, 255, 0.5); padding: 3%; width: 25vw; display: flex; flex-direction: column; justify-content: center; height: fit-content; background-color: rgba(255, 255, 255, 0.95);"
