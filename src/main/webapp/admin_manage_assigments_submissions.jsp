	...
	<div class="dashboard" style="displaye: flex; flex-direction: row;background-color:white;">
		<div class="panel" style="display: flex; flex-direction: column; width: 20vw; padding: 2%; height: fit-content; background-color: #f4f4f5;border-top-left-radius: 0%;border-top-right-radius: 80%;border-bottom-left-radius: 0%;border-bottom-right-radius: 80%">
			...
			<button class="btn btn-primary" type="button"
				data-bs-toggle="collapse" data-bs-target=".no-collapse" onclick='redirectTo("http://localhost:8090/TestingPROJECT/DashboardLoader")'
			...
			<div class="column" style="padding:3%">
				...
				<div class="col">
					<div class="collapse multi-collapse ass-collapse show"
						id="ass" style="padding:2%;	background-color:#4f52ff;
	color:white;
	cursor:pointer;" onclick='redirectTo("http://localhost:8090/TestingPROJECT/admin_submitted_assignment_manage_loader")'>
						<h6
							>Assignment
							Submissions</h6>
					</div>
		...
		<div style="display:flex;flex-direction:column;width:85vw;" id="wall">
			...
			<c:if test="${empty AllSubmittedAssignments}">
					<h1 style="color:#263339;font-size:5vh;padding:0%;margin-left:4vh;">No Submissions Available.</h1>
			</c:if>
			
			
			<c:if test="${not empty AllSubmittedAssignments}">
				<table id="tblDetail"
					style="max-width: 65%; box-shadow: 0 4px 8px #263339;background-color: rgba(255, 255, 255, 0.8);" >
					<tr id="headlines">
						<th>Assignment ID</th>
						<th>Student ID </th>
						<th>Student Name </th>
