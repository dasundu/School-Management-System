...
.login .image {
	...
	background-image: url("./images/fPass.svg");
...
<body id="body1"
	style="background: linear-gradient(45deg, #1e2167, #e0e1e1)">
	<!-- Hidden Pop-up Box -->
	<div id="popup" class="popup">
		<div class="popup-content">
			<h1>Email Not Found</h1>
			<img src="./images/nodata.gif" height="200" width="200">
			<p>
				We couldn't find an account associated with the provided <b>email</b>
				address.<br> Please make sure the email is correct or consider
				if you don't have an account.<br> If you continue to experience
				issues, contact our support for further assistance.
			</p>
	...
	<div class="login">
		...
		<div class="content">
			...
			<h1
				style="color: #263339; font-size: 5vh; padding: 0%; margin-left: 4vh;">Password
				Recovery</h1>
				<br><br>
			<form action="recovery1" method="post">
				<label>Enter your email address</label><br> <input type="email"
					required id="pw" name="email"><br />
				<br>
	...
	<script>
    		...
    		var credValue = '<%=request.getAttribute("checkedEmail")%>';
