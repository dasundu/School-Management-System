...
#wall{
	height:90vh;
	width:100%;
	background-image: url("./images/newSub.svg");
...
<body style="margin:1%;background-color:#273239;">
	...
	<div id="loginSuccessBox" class="popup">
		<div class="popup-content" style="width:25vw;height:30vh">
				<h3 style="color:#4f52ff;">Subject Added Successfully!</h3><br>
	...
	color:white;
	cursor:pointer;" onclick='redirectTo("add_new_subject.jsp")'>
						<h6
							>Add
							New Subject</h6>
					</div>
	...
	<form action="add_new_subject" method="post" style="margin:5%;box-shadow: 0 4px 8px rgba(79, 82, 255, 0.5);padding:3%;width:35vw;display:flex;flex-direction:column;background-color: rgba(255, 255, 255, 0.9);">
    <h2 style ="color:#263339;">Add New Subject</h2><br><br>
    ...
    <input type="number" name="no_of_hours"><br>

    <label for="enrollment_key">Enrollment Key:</label>
    <input type="text" name="enrollment_key"pattern="S\d{3}" title="Enrollment key must start with 'S' followed by a 3-digit number"><br><br>
	
	<div style="display:flex;flex-direction:column;justify-content:center;align-items:center;">
    <button type="submit" id="altBtn"  style="width:12vw;">Add</button></div>
	</form>
</div>
	</div>
	<script>
