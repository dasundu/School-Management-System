...
#wall{
	...
	height:fit-content;
	width:100%;
	background-image: url("./images/enrollB.svg");
...
<body style="margin:1%;background-color:#273239;">
	...
	<div id="loginSuccessBox" class="popup">
		<div class="popup-content" style="width:25vw;height:30vh">
				<h3 style="color:#4f52ff;">Successfully Enrolled !</h3><br>
	...
	<div class="dashboard" style="displaye: flex; flex-direction: row;background-color:white;border-bottom-right-radius: 5%;">
		<div class="panel" style="display: flex; flex-direction: column; width: 20vw; padding: 2%;height: fit-content; background-color: #f4f4f5;border-top-left-radius: 0%;border-top-right-radius: 80%;border-bottom-left-radius: 0%;border-bottom-right-radius: 80%">
			...
			<button class="btn btn-primary" type="button"
				...
				aria-expanded="false" aria-controls="sub" style="font-weight:600;text-align:left;background-color:white;color:#4f52ff;border:none;font-size:2vh;box-shadow: 0 4px 18px rgba(79, 82, 255, 0.5);"><img src="./images/dashboard.gif"
			...
			<div class="column" style="padding:3%">
				<div class="col" onclick='redirectTo("http://localhost:8090/TestingPROJECT/student_subject_info_loader")'>
					<div class="collapse multi-collapse sub-collapse show"
				...
				<div class="col" onclick='redirectTo("http://localhost:8090/TestingPROJECT/student_enroll_for_subjects_info_loader")'>
					<div class="collapse multi-collapse sub-collapse show"
						id="sub" style="padding:3%;	background-color:#4f52ff;color:white;cursor:pointer;">
						<h6
	...
	<div style="display:flex;flex-direction:column;width:70vw;" id = "wall">
			...
			<div style="display:flex;flex-flow:row wrap;justify-content:center;align-items:center;">
				...
				<div style="box-shadow: 0 4px 8px #263339;width:17vw;height:27vh;padding:2%;margin:2%; background-color: rgba(255, 255, 255, 0.95);">
					<form action ="student_enroll_subject" method ="get">
						<h4> ${subject.getSubName()} : ${subject.getSubjectId() }</h4>
						<p style="color:#4f52ff;font-weight:600">${subject.getDescription()}</p>
						
						<p style="color:#565c62;font-weight:600">Enrollment key <input type ="text" name="EnrollmentKey" style="height:2.5vh;width:5vw;font-weight:600;background-color:white;"><input type="hidden" name="subjectId" value="${subject.getSubjectId()}" ></p>
						<div style="display:flex;justify-content:center">
						<button type="submit" id="altBtn" style="width:8vw">Enroll</button></div>
					</form>
					</div>
