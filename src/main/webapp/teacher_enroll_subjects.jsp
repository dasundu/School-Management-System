...
#manageStudents, #classes, #res, #set#ass,#sub, #addStudent, #login,
	#Teacher, #classes {
	padding: 5%;
	text-align: left;
	transition-duration: 0.3s;
...
#manageStudents:hover, #classes:hover, #res:hover, #set:hover, #ass:hover,
	#sub:hover, #addStudent:hover, #login:hover, #Teacher:hover,
	#classes:hover {
	background-color: #4f52ff;
	color: white;
	cursor: pointer;
...
#wall {
	...
	height: fit-content;
	width: 100%;
	background-image: url("./images/subjectBack.svg");
...
<body style="margin:1%;background-color:#273239;">
	...
	<div id="loginSuccessBox" class="popup">
		<div class="popup-content" style="width: 25vw; height: 30vh">
			<h3 style="color: #4f52ff;">Enrolled Successfully!</h3>
	...
	<div class="dashboard" style="displaye: flex; flex-direction: row;background-color:white;border-bottom-right-radius: 5%;">
		<div class="panel" style="display: flex; flex-direction: column; width: 20vw; padding: 2%; height: fit-content; background-color: #f4f4f5;border-top-left-radius: 0%;border-top-right-radius: 80%;border-bottom-left-radius: 0%;border-bottom-right-radius: 80%">
			...
			<div class="column" style="padding: 3%">
				<div class="col">
					<div class="collapse multi-collapse students-collapse"
						id="manageStudents"
						onclick='redirectTo("http://localhost:8090/TestingPROJECT/teacher_mange_students_loader")'
						style="padding: 2%">
						<h6>Manage My Students</h6>
					</div>
				</div>
			</div>
			...
			<button class="btn btn-primary" type="button"
				...
				style="font-weight: 600; text-align: left; background-color: white; color: #4f52ff; border: none; box-shadow: 0 4px 8px rgba(79, 82, 255, 0.5); font-size: 2vh;">
				<img src="./images/collegeclass.gif" width="80" height="80"
					style="margin-right: 5%">Classes
			</button>

			<div class="column" style="padding: 3%">
				<div class="col">
					<div class="collapse multi-collapse class-collapse" id="classes"
						onclick='redirectTo("http://localhost:8090/TestingPROJECT/teacher_classes_info_loader")'
						style="padding: 2%">
						<h6>View My Classes Info</h6>
					</div>
				</div>
			</div>
			...
			<div class="column" style="padding: 3%">
				<div class="col">
					<div class="collapse multi-collapse ass-collapse" id="ass"
						onclick='redirectTo("http://localhost:8090/TestingPROJECT/teacher_announced_assignments_loader")'
						style="padding: 3%">
				...
				<div class="col">
					<div class="collapse multi-collapse ass-collapse" id="ass"
						onclick='redirectTo("http://localhost:8090/TestingPROJECT/add_new_assignment_loader")'
						style="padding: 3%">
				...
				<div class="col">
					<div class="collapse multi-collapse ass-collapse" id="ass"
						onclick='redirectTo("http://localhost:8090/TestingPROJECT/teacher_manage_submitted_assignment_info_loader")'
						style="padding: 3%">
			...
			<button class="btn btn-primary" type="button"
				...
				style="font-weight: 600; text-align: left; background-color: white; color: #4f52ff; border: none; box-shadow: 0 4px 18px rgba(79, 82, 255, 0.5); font-size: 2vh;">
				<img src="./images/subjects.gif" width="80" height="80"
					style="margin-right: 5%">Subjects
			</button>

			<div class="column" style="padding: 3%">
				<div class="col">
					<div class="collapse multi-collapse sub-collapse show" id="sub"
						onclick='redirectTo("http://localhost:8090/TestingPROJECT/teacher_assigned_subjects_loader")'
						style="padding: 3%">
				...
				<div class="col">
					<div class="collapse multi-collapse sub-collapse show" id="sub"
						onclick='redirectTo("http://localhost:8090/TestingPROJECT/teacher_enroll_subject_info_loader")'
			...
			<div class="column" style="padding: 3%">
				<div class="col">
					<div class="collapse multi-collapse res-collapse" id="res"
						onclick='redirectTo("http://localhost:8090/TestingPROJECT/teacher_result_panel_loader")'
						style="padding: 3%">
						<h6>Published Results</h6>
					</div>
					<div class="collapse multi-collapse res-collapse" id="res"
						onclick='redirectTo("http://localhost:8090/TestingPROJECT/teacher_publish_results_page_loader")'
						style="padding: 3%">
						<h6>Publish New Results</h6>
					</div>
				</div>
			</div>
			...
			<div class="column" style="padding: 3%">
				<div class="col">
					<div class="collapse multi-collapse set-collapse" id="set"
						onclick='redirectTo("teacher_update_account.jsp")'
						style="padding: 3%">
				...
				<div class="column">
					<div class="col">
						<div class="collapse multi-collapse set-collapse" id="set"
							onclick='redirectTo("teacher_delete_account.jsp")'
							style="padding: 3%">
		...
		<div style="display: flex; flex-direction: column; width: 70vw;"id="wall">
			...
			<div style="display: flex; flex-flow: row wrap">
				<c:forEach var="subject" items="${AllSubjects}">
					...
					<form action="teacher_enroll_subject" method="get"
						style="box-shadow: 0 4px 8px #263339; width: 17vw; height: 27vh; padding: 2%; margin: 2%; background-color: rgba(255, 255, 255, 0.9);">
						<h4>${subject.getSubName()}</h4>
						<p style="color: #4f52ff; font-weight: 600">${subject.getDescription()}</p>

						<p>
							Enrollment key :<input type="text" name="EnrollmentKey"
								style="height: 2.5vh; width: 5vw; font-weight: 600; background-color: white;"><input
								type="hidden" name="subjectId" value="${subject.getSubjectId()}">
						</p>
						<div style="display: flex; justify-content: center">
							<button type="submit" id="altBtn" style="width: 8vw">Enroll</button>
						</div>
					</form>
