...
<body id="body1"
	...
	<div id="popup" class="popup">
		<div class="popup-content">
			...
			<p>
				Invalid OTP! Please enter the correct One-Time Password to proceed.
			</p>
	...
	<div class="login">
		...
		<div class="content">
			...
			<form action="ValidateOtp" method="post">
				<label>Enter OTP Code that sent to your email</label><br> 
				
				<input type="number" required id="pw" name="otp"><br />
				<br>
