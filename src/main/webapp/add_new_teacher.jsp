...
#wall{
	height:90vh;
	width:100%;
	background-image: url("./images/newT.svg");
...
<body style="margin-top:1%;">
	...
	<div id="loginSuccessBox" class="popup">
		<div class="popup-content" style="width:25vw;height:30vh">
				<h3 style="color:#4f52ff;">Teacher added Successfully!</h3><br>
			...
			<div class="column" style="padding:3%" >
				<div class="col">
					<div class="collapse multi-collapse teachers-collapse show"
						id="Teacher" onclick='redirectTo("add_new_teacher.jsp")' style="padding:2%;	background-color:#4f52ff;
	color:white;
	cursor:pointer;">
						<h6
							>Add
	...
	<div style="display:flex;flex-direction:column;width:85vw;" id ="wall">
	       <form action="add_new_teacher" method="post" enctype="multipart/form-data" style="margin:5%;box-shadow: 0 4px 8px rgba(79, 82, 255, 0.5);padding:3%;display:flex;flex-direction:column;width:48vw;background-color: rgba(255, 255, 255, 0.8);" onsubmit="return handleSubmit()">
	       	<div style="display:flex;flex-direction:row;">
	       	<div style="margin:4%;">
	       	<fieldset>
	       	<h1 style="color:#263339;">Account Info</h1>
                ...
                <input type="password"  required id="teacherPass" name="password"pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Password must contain at least one number, one uppercase and lowercase letter, and be at least 8 characters long"><br /><br>

				<label style = "font-weight:600;font-size:2vh;">Upload Teacher's Photo</label><br>
            	<input type = "file" name="pic" required><br><br>
			</fieldset></div>
			<div style="margin:4%;">
			<fieldset>
	       	<h1 style="color:#263339;">Teacher Info</h1>
                ...
                <input type="text"  required id="pw" name="specialization"><br /><br>
...
<script>
  ...
  function handleSubmit() {
    ...
    const passwordInput = document.getElementById('teacherPass').value;
    ...
    document.getElementById('teacherPass').value = hashedPassword;
