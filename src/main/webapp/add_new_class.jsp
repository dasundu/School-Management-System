...
#wall{
	height:90vh;
	width:100%;
	background-image: url("./images/classB.svg");
...
<body style="margin:1%;background-color:#273239;">
	...
	<div id="loginSuccessBox" class="popup">
		<div class="popup-content" style="width:25vw;height:30vh">
				<h3 style="color:#4f52ff;">New Class Added Successfully!</h3><br>
	...
	color:white;
	cursor:pointer;" onclick='redirectTo("add_new_class.jsp")'>
						<h6
							>Add
							new class</h6>
					</div>
	...
	<div style="display:flex;flex-direction:column;width:85vw;" id = "wall">
		<form action="add_new_class" method="post" style="margin:5%;box-shadow: 0 4px 8px rgba(79, 82, 255, 0.5);padding:3%;width:35vw;display:flex;flex-direction:column;background-color: rgba(255, 255, 255, 0.9);">
			<h1 style="color:#263339">Add New Class Room</h1>
			
			<label for="subjectname">Class Name:</label>
			 <input type="text"
				name="classname" required><br>
				
				<label for="description">Room
				Number:</label> <input type="text" name="roomnumber"><br><br>
			
			<div style="display:flex;flex-direction:column;justify-content:center;align-items:center;">
			<button type="submit" id="altBtn" style="width:8vw">Add</button></div>
		</form>
