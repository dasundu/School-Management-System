...
#wall{
	...
	height:fit-content;
	width:100%;
	background-image: url("./images/stMan.svg");
...
<div class="loader"></div>
	...
	<div id="loginSuccessBox" class="popup">
		<div class="popup-content" style="width:25vw;height:30vh">
				<h3 style="color:#4f52ff;">Student Update Successful!</h3><br>
	...
	<div id="deleteSuccessBox" class="popup">
		<div class="popup-content" style="width:25vw;height:30vh">
				<h3 style="color:#4f52ff;">Deletion Successful!</h3><br>
				<img src="./images/appok.gif" height="200" width="200"><br>
	...
	<div id="delete" class="popup">
		<div class="popup-content">
			<form action="teacher_delete_student" method="post">
				<h5>
					Are you sure you want to<br> delete this student?
				</h5>
				...
				<input type="hidden" id="studentClass" value="" name="studentClass">
	...
	<div id="update" class="popup">
		<div class="popup-content">
			<form action="teacher_update_student" method="post" style="text-align:left;">

				<input type="hidden" id="userid" name="userid">
			
				<label style="font-weight:600;font-size:2vh;color:#4f52ff">First Name</label><br>
                <input type="text"  required  name="fname" style="font-weight:600;" id="fname"><br /><br>

				<label style="font-weight:600;font-size:2vh;color:#4f52ff">Last Name</label><br>
                <input type="text"  required  name="lname" style="font-weight:600;" id="lname"><br /><br>

                <label style="font-weight:600;font-size:2vh;color:#4f52ff">Birth Date</label><br>
                <input type="text"  required  name="bdate" style="font-weight:600;" id="bdate"><br /><br>
                
                <label style="font-weight:600;font-size:2vh;color:#4f52ff">Telephone</label><br>
                <input type="text"  required  name="telephone" style="font-weight:600;" id="telephone"><br /><br>
                
             	<label style="font-weight:600;font-size:2vh;color:#4f52ff">Address</label><br>
                <input type="text"  required  name="address" style="font-weight:600;" id="address"><br /><br>
	...
	<div class="dashboard" style="displaye: flex; flex-direction: row;background-color:white;border-bottom-right-radius: 5%;">
		<div class="panel" style="display: flex; flex-direction: column; width: 20vw; padding: 2%; height: fit-content; background-color: #f4f4f5;border-top-left-radius: 0%;border-top-right-radius: 80%;border-bottom-left-radius: 0%;border-bottom-right-radius: 80%">
			...
			<div class="column" style="padding:3%">
				<div class="col" >
					<div class="collapse multi-collapse students-collapse show"
						id="manageStudents" onclick='redirectTo("http://localhost:8090/TestingPROJECT/teacher_mange_students_loader")' style="padding:2%;	background-color:#4f52ff;
	color:white;
	cursor:pointer;">
						<h6
							>Manage My
			...
			<div class="column" style="padding:3%">
				<div class="col" >
					<div class="collapse multi-collapse class-collapse"
						id="classes" onclick='redirectTo("http://localhost:8090/TestingPROJECT/teacher_classes_info_loader")' style="padding:2%">
						<h6
							>View My
							Classes Info</h6>
					</div>
			...
			<div class="column">
				<div class="col">
					<div class="collapse multi-collapse set-collapse"
						id="set" onclick='redirectTo("http://localhost:8090/TestingPROJECT/teachersPageLoader")' style="padding:3%">
						<h6
							>Account Deletion
							</h6>
					</div>
	...
	<div style="display:flex;flex-direction:column;width:70vw;align-items:left;" id = "wall">
	
		<c:if test="${empty AssignedClasses}">
			<h1 style="color:#263339;font-size:5vh;padding:0%;margin-left:4vh;">Not any assigned classes found.</h1>
		</c:if>
		<c:if test="${not empty AssignedClasses}">
		   <form action="load_teacher_related_class_students" method="get" style="margin:2%;">

                
                <label for="classSelect" style="font-weight:600;font-size:2vh;">My Classes:</label>
    			<select name="classSelect" style="font-weight:600;">
        			<c:forEach var="classr" items="${AssignedClasses}" >
            				<option value="${classr.getClassid()}" style="font-weight:600;">${classr.getClassName()}</option>
        			</c:forEach>
    			</select>
                
                
                <button type="submit" id="altBtn">Search Students</button>
		...
		<div class="dataTable">
			<table id="tblDetail"
				style="max-width: 100%; box-shadow: 0 4px 8px #263339;background-color: rgba(255, 255, 255, 0.97);">
				<tr id="headlines">
					<th>ID</th>
					<th>Class ID</th>
					<th>Birth Day</th>
				...
				<c:forEach var="student" items="${Allstudents}">
					<tr>
						...
						<td><button id="altBtn" onclick="showPopupUpdate('${student.getId()}','${student.getFirstName()}','${student.getLastName()}','${student.getBirthDay()}','${student.getTelephone() }','${student.getAddress() }')">Update</button></td>
						<td><button id="altBtn" onclick ="showPopupDelete('${student.getId()}','${student.getClassName()}')">Delete</button></td>
					</tr>
				</c:forEach>
			</table>
		</div></c:if>
	...
	window.addEventListener("load", () => {
		...
		//Show delete box
		function showPopupDelete(userId,clasId) {
			// Set the user ID in the popup content
			document.getElementById("userIdSpan").value = userId;
			document.getElementById("studentClass").value = clasId;
		...
		//Show update box
		function showPopupUpdate(uid,fname,lname,bdate,telephone,address) {
