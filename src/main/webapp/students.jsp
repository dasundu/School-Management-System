...
.blur-background {
  ...
  background-color:red; /* Adjust the blur amount as needed */
...
/* Add a class to show the loader and blurred background */
...
<body style="margin:1%">
  ...
  <div class="loader"></div>
	...
	<div id="update" class="popup">
		<div class="popup-content">
			<form action="admin_update_student" method="post" style="text-align:left;">
                ...
                <input type="hidden" value="" id="oldClass" name="oldClass">
                
                
                <label style="font-weight:600;font-size:2vh;color:#4f52ff">Class</label><br>
                <select name ="selectedNewClass">
                		<c:forEach var="classroom" items="${Allclasses}">
	...
	<div class="header" style="padding:1%;background-color:white;border-radius:71% 79% 0% 34% / 100% 100% 10% 0% ">
		...
		<div
			...
			<input type="text" id="searchInput" onkeyup="filterTable()"
				placeholder="Search by ID" style="margin-rigt: 2%;font-weight:600">
		</div>
			...
			<div class="column" style="padding:3%">
				<div class="col">
					<div class="collapse multi-collapse students-collapse show"
						id="addStudent" onclick='redirectTo("http://localhost:8090/TestingPROJECT/add_new_student_page_loader")' style="padding:2%">
						<h6
							>Enroll a new
							Student</h6>
					</div>
				...
				<div class="col">
					<div class="collapse multi-collapse students-collapse show "
						id="manageStudents" onclick='redirectTo("http://localhost:8090/TestingPROJECT/studentsPageLoader")' style="padding:2%;	background-color:#4f52ff;
	color:white;
	cursor:pointer;">
						<h6
							>Manage
	...
	<div style="display:flex;flex-direction:column;width:85vw;" id="wall">
		...
		<div class="dataTable">
			<table id="tblDetail"
				style="max-width: 100%; box-shadow: 0 4px 8px rgba(79, 82, 255, 0.5);background-color: rgba(255, 255, 255, 0.95);">
				<tr id="headlines">
					<th>ID</th>
					<th>Class ID</th>
					<th>Birth Day</th>
				...
				<c:forEach var="student" items="${Allstudents}">
					<tr>
						...
						<td><button id="altBtn" onclick="showPopupUpdate('${student.getId()}','${student.getFirstName()}','${student.getLastName()}','${student.getBirthDay()}','${student.getTelephone() }','${student.getAddress() }','${student.getClassName()}')">Update</button></td>
	...
	window.addEventListener("load", () => {
		...
		//Show update box
		function showPopupUpdate(uid,fname,lname,bdate,telephone,address,oldclass) {
			...
			document.getElementById("oldClass").value = oldclass;
