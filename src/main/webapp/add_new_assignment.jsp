...
<body style="margin:1%;background-color:#273239;">
	...
	<div id="loginSuccessBox" class="popup">
		<div class="popup-content" style="width:25vw;height:30vh">
				<h3 style="color:#4f52ff;">Assignment announced successfully!</h3><br>
	...
	<div class="dashboard" style="displaye: flex; flex-direction: row;background-color:white;border-bottom-right-radius: 5%;">
		<div class="panel" style="display: flex; flex-direction: column; width: 20vw; padding: 2%; height: fit-content; background-color: #f4f4f5;border-top-left-radius: 0%;border-top-right-radius: 80%;border-bottom-left-radius: 0%;border-bottom-right-radius: 80%">
			...
			<div class="column" style="padding:3%">
				...
				<div class="col">
					<div class="collapse multi-collapse ass-collapse show"
						id="ass" onclick='redirectTo("http://localhost:8090/TestingPROJECT/add_new_assignment_loader")' style="padding:3%	;background-color:#4f52ff;
	color:white;
	cursor:pointer;">
						<h6
							>New
			...
			<div class="column" style="padding:3%"> 
				<div class="col">
					<div class="collapse multi-collapse set-collapse"
						id="set" onclick='redirectTo("admin_update_account.jsp")' style="padding:3%">
						<h6
							>Account Update
							</h6>
					</div>
...
<div style="display:flex;flex-direction:column;width:70vw;" id="wall">
    ...
    <form action="add_new_assignment" method="post" enctype="multipart/form-data" style="margin:5%;box-shadow: 0 4px 8px #263339;padding:3%;width:fit-content;background-color: rgba(255, 255, 255, 0.9);">
    
    <h2>Create New Assignment</h2><br><br>
    
        <label for="assignmentTitle" style="font-weight:600;font-size:2vh;">Assignment Title:</label><br>
        <input type="text" name="assignmentTitle" required style="font-weight:600;"><br>
        <br>

				<label for="classSelect" style="font-weight:600;font-size:2vh;">Select Class:</label> <br><select
					name="classId" style="font-weight:600;">
			...
			<label for="classSelect" style="font-weight:600;font-size:2vh;">Select Subject:</label> <br>
				<select name="subjectId" style="font-weight:600;">
				
					<c:forEach var="subject" items="${Subjects}">
					
						<option value="${subject.getSubjectId()}" style="font-weight:600;"> ${subject.getSubName()} </option>
						
					</c:forEach>
				</select>
				<br><br>

        <label for="assignmentInfo" style="font-weight:600;font-size:2vh;">Assignment Information (PDF type only):</label><br>
        <input type="file" name="assignmentInfo" accept=".pdf" required><br>
        <br>
		<div style="display:flex;flex-direction:column;justify-content:center;align-items:center;">
        <button type ="submit" id="altBtn" style="width:6vw">Submit</button></div>
    </form>
   </div>
