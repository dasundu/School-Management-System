			...
			<div class="column" style="padding:3%">
				<div class="col" >
					<div class="collapse multi-collapse sub-collapse show"
						id="sub" onclick='redirectTo("http://localhost:8090/TestingPROJECT/teacher_assigned_subjects_loader")' style="padding:3%;	background-color:#4f52ff;
	color:white;
	cursor:pointer;">
						<h6
							>Assigned Subjects
		...
		<div style="display:flex;flex-direction:column;width:70vw;" id="studentSub">
			<c:if test="${empty AllSubjects}">
			...
			<div style="display:flex;flex-flow:row wrap;justify-content:center;align-items:center">
				...
				<div style="box-shadow: 0 4px 8px rgba(79, 82, 255, 0.5);width:20vw;height:15vh;padding:2%;margin:2%;background-color: rgba(218, 218, 249, 0.76);">

						<h4> ${subject.getSubName()} : ${subject.getSubjectId() }</h4>
						<p style="color:#4f52ff;font-weight:600">${subject.getDescription()}</p>
						<p style="font-weight:600">Number of Hours :${subject.getNumOfHours()}</p>
					</div>
