...
#wall{
	...
	height:fit-content;
	width:100%;
	background-image: url("./images/resSub.svg");
...
<div class="loader"></div>
	...
	<div id="loginSuccessBox" class="popup">
		<div class="popup-content" style="width:25vw;height:30vh">
				<h3 style="color:#4f52ff;">Result published successfully!</h3><br>
	...
	<div class="dashboard" style="displaye: flex; flex-direction: row;background-color:white;border-bottom-right-radius: 5%;">
		<div class="panel" style="display: flex; flex-direction: column; width: 20vw; padding: 2%; height: fit-content; background-color: #f4f4f5;border-top-left-radius: 0%;border-top-right-radius: 80%;border-bottom-left-radius: 0%;border-bottom-right-radius: 80%">
			...
			<div class="column" style="padding:3%">
				<div class="col" >
					<div class="collapse multi-collapse res-collapse show"
					...
					<div class="collapse multi-collapse res-collapse show"
						id="res" onclick='redirectTo("http://localhost:8090/TestingPROJECT/teacher_publish_results_page_loader")' style="padding:3%;	background-color:#4f52ff;
	color:white;
	cursor:pointer;">
						<h6
							>Publish New
	    ...
	    <form action="teacher_publish_new_results" method="post" enctype="multipart/form-data" style="margin:5%;box-shadow: 0 4px 8px #263339;background-color: rgba(255, 255, 255, 0.9);padding:3%;width:35vw;">
    
    <h2>Publish Results</h2><br><br>
    
        <label for="assignmentTitle" style="font-weight:600;font-size:2vh;">Result Description:</label><br>
        <input type="text" name="resultDescription" required style="font-weight:600;"> <br>
        <br>
				...
				<label for="classSelect" style="font-weight:600;font-size:2vh;">Select Class:</label> <br><select
					...
					<c:forEach var="classr" items="${AssignedClasses}">
						<option value="${classr.getClassid()}" style="font-weight:600;">${classr.getClassid()} - ${classr.getClassName()} </option>
					</c:forEach>
				</select> <br>        <br>
        ...
        <label for="assignmentInfo" style="font-weight:600;font-size:2vh;">Result Sheet(PDF type only):</label><br>
        <input type="file" name="ResultSheet" accept=".pdf" required><br>
        <br>        <br>
		<div style="display:flex;flex-direction:column;justify-content:center;align-items:center;">
        <button type ="submit" id="altBtn" style="width:6vw">Publish</button></div>
    </form>
