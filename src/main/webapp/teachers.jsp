...
#wall{
	...
	height:fit-content;
	width:100%;
	background-image: url("./images/teacherM.svg");
...
<body style="margin:1%;background-color:#273239;">
	...
	<div id="loginSuccessBox" class="popup">
		<div class="popup-content" style="width:25vw;height:30vh">
				<h3 style="color:#4f52ff;">Teacher Update Successful!</h3><br>
	...
	<div id="update" class="popup">
		<div class="popup-content">
			<form action="admin_update_teacher" method="post" style="text-align:left;">
                ...
                <input type="text"  required  name="address" style="font-weight:600;" id="address"><br /><br>
             	...
             	<label style="font-weight:600;font-size:2vh;color:#4f52ff">Specialization</label><br>
                <input type="text"  required  name="speci" style="font-weight:600;" id="speci"><br /><br>
	...
	<div class="dashboard" style="displaye: flex; flex-direction: row;background-color:white;">
		<div class="panel" style="display: flex; flex-direction: column; width: 20vw; padding: 2%; height: fit-content; background-color: #f4f4f5;border-top-left-radius: 0%;border-top-right-radius: 80%;border-bottom-left-radius: 0%;border-bottom-right-radius: 80%">
			...
			<div class="column" style="padding:3%" >
				<div class="col">
					<div class="collapse multi-collapse teachers-collapse show"
				...
				<div class="col">
					<div class="collapse multi-collapse teachers-collapse show"
						id="Teacher" onclick='redirectTo("http://localhost:8090/TestingPROJECT/teachersPageLoader")' style="padding:2%;	background-color:#4f52ff;
	color:white;
	cursor:pointer;">
						<h6
							>Manage
	...
	<div style="display:flex;flex-direction:column;width:85vw;" id = "wall">
		...
		<div class="dataTable">
			<table id="tblDetail"
				style="max-width: 100%; box-shadow: 0 4px 8px rgba(79, 82, 255, 0.5);background-color: rgba(255, 255, 255, 0.8);">
				<tr id="headlines">
					<th>ID</th>
				...
				<c:forEach var="teacher" items="${AllTeachers}">
					<tr>
						...
						<td><button id="altBtn" onclick="showPopupUpdate('${teacher.getId()}','${teacher.getFirstName()}','${teacher.getLastName()}','${teacher.getBirthday()}','${teacher.getTelephone()}','${teacher.getAddress()}','${teacher.getSpecialization()}')">Update</button></td>
						<td><button id="altBtn" onclick ="showPopupDelete('${teacher.getId()}')">Delete</button></td>
					</tr>
				</c:forEach>
			</table>
		</div>
...
<a href="#" class="back-to-top">
	...
	<script>
	//Show update box
	function showPopupUpdate(uid,fname,lname,bdate,telephone,address,spci) {
		...
		document.getElementById("speci").value = spci;
