...
<div class="loader"></div>
	...
	<div id="delete" class="popup">
		<div class="popup-content">
			<form action="admin_delete_result" method="post">
				<h5>
			...
			<div class="column" style="padding:3%">
				<div class="col">
					<div class="collapse multi-collapse res-collapse show"
						id="res" style="padding:2%;	background-color:#4f52ff;
	color:white;
	cursor:pointer;" onclick='redirectTo("http://localhost:8090/TestingPROJECT/admin_published_results_loader")'>
						<h6
							>Published
							Results</h6>
					</div>
			...
			<div class="column" style="padding:3%">
				<div class="col">
					<div class="collapse multi-collapse set-collapse"
						id="set" style="padding:2%" onclick='redirectTo("http://localhost:8090/TestingPROJECT/admin_update_account.jsp")'>
						<h6
							>Account Update
							</h6>
					</div>
	...
	<div style="display:flex;flex-direction:column;width:85vw;" id ="wall">
			...
			<div class="dataTable">
			<table id="tblDetail"
				style="max-width: 80%; box-shadow: 0 4px 8px rgba(79, 82, 255, 0.5);background-color: rgba(255, 255, 255, 0.96);">
				<tr id="headlines">
					<th>Result ID </th>
					<th>Description</th>
					<th>Subject </th>
				...
				<c:forEach var="res" items="${AllResults}">
					<tr>
						...
						<td>
							<button onclick="openPdfModal('${res.getSheet()}')" id="altBtn">View
								</button>
...
<script>
	...
	window.addEventListener("load", () => {
		...
		function showPopupDelete(resId) {
			...
			document.getElementById("resultId").value = resId;
